package com.example.cryptoapp.coingecko;
import com.example.cryptoapp.coingecko.domain.Coins.CoinFullData;
import com.example.cryptoapp.coingecko.domain.Coins.CoinHistoryById;
import com.example.cryptoapp.coingecko.domain.Coins.CoinList;
import com.example.cryptoapp.coingecko.domain.Coins.CoinMarkets;
import com.example.cryptoapp.coingecko.domain.Coins.CoinTickerById;
import com.example.cryptoapp.coingecko.domain.Coins.MarketChart;
import com.example.cryptoapp.coingecko.domain.Events.EventCountries;
import com.example.cryptoapp.coingecko.domain.Events.EventTypes;
import com.example.cryptoapp.coingecko.domain.Events.Events;
import com.example.cryptoapp.coingecko.domain.ExchangeRates.ExchangeRates;
import com.example.cryptoapp.coingecko.domain.Exchanges.ExchangeById;
import com.example.cryptoapp.coingecko.domain.Exchanges.Exchanges;
import com.example.cryptoapp.coingecko.domain.Exchanges.ExchangesList;
import com.example.cryptoapp.coingecko.domain.Exchanges.ExchangesTickersById;
import com.example.cryptoapp.coingecko.domain.Global.Global;
import com.example.cryptoapp.coingecko.domain.Ping;
